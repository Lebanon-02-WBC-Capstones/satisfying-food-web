  ...
  return (
    <div>
      <div className="w-full h-11 bg-yellow-500 "></div>
        <div className="wp-full h-full bg-yellow-500 flex justify-center pb-4 -m-px " >
          
        <SearchBar onSearch={handleSearch} /></div>
        <div className="w-full h-full"> 
        
        <div className="ml-8 mt-8 flex-nowarp ">
        ...
        <h2 className="text-yellow-500 font-bold text-2xl pb-2 ">Duration</h2>
        <div className="w-full flex justify-around -ml-4">
        <Filter time="15 Min"/> <Filter time="30 Min"/><Filter time="<1 hr"/> <Filter time=">1 hr"/>
         </div>
        <div>
